...
export function ApiKeysIcon({ size }: { size?: number }) {
  return (
    <Icon size={size}>
...
export function UsageIcon({ size }: { size?: number }) {
  return (
    <Icon size={size}>
...
export function BillingIcon({ size }: { size?: number }) {
  return (
    <Icon size={size}>
...
export function ProjectsIcon({ size }: { size?: number }) {
  return (
    <Icon size={size}>
