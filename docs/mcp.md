...
| `forgecad_design_generate` | ForgeCAD | 60 |
| `forgecad_openscad_generate` | ForgeCAD | 40 |
| `forgecad_bom_generate` | ForgeCAD | 20 |
| `forgecad_cutlist_generate` | ForgeCAD | 20 |
| `forgecad_assembly_plan` | ForgeCAD | 25 |
| `forgecad_printability_check` | ForgeCAD | 25 |
| `forgecad_manufacturability_check` | ForgeCAD | 30 |
| `forgecad_design_review` | ForgeCAD | 40 |
| `forgecad_material_estimate` | ForgeCAD | 20 |
| `forgecad_tools_detect` | ForgeCAD | 5 |
