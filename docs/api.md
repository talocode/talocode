...
| `/v1/forgecad/` | ForgeCAD (CAD workflow) | `POST /v1/forgecad/design/generate`, `POST /v1/forgecad/openscad/generate`, `POST /v1/forgecad/bom/generate`, `POST /v1/forgecad/cutlist/generate`, `POST /v1/forgecad/assembly/plan`, `POST /v1/forgecad/printability/check`, `POST /v1/forgecad/manufacturability/check`, `POST /v1/forgecad/design/review`, `POST /v1/forgecad/material/estimate`, `POST /v1/forgecad/tools/detect`, `POST /v1/forgecad/render/openscad`, `POST /v1/forgecad/export/markdown`, `POST /v1/forgecad/export/json` |
